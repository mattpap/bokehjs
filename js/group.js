...
(function() {
  var Collections, group_demo, make_glyph_test;

  Collections = require('../base').Collections;

  make_glyph_test = require('../testutils').make_glyph_test;

  group_demo = function(div_id) {
    var a, b, c, source, xdr, ydr;
    ...
    return this.make_plot(div_id, source, {}, [a, b, c], xdr, ydr, false, [600, 600]);
  };
