...
(function() {
  var Collections, make_glyph_test, stack_demo;

  Collections = require('../base').Collections;

  make_glyph_test = require('../testutils').make_glyph_test;

  stack_demo = function(div_id) {
    var a, b, c, d, e, source, xdr, ydr;
    ...
    return this.make_plot(div_id, source, {}, [a, b, c, d, e], xdr, ydr, false, [600, 600]);
  };
